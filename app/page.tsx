      ...
      <main className="relative flex flex-col items-center justify-center pt-40 pb-32 px-4 text-center">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-24">
            <button className="bg-emerald-500 text-black px-10 py-4 rounded-xl font-bold text-lg hover:bg-emerald-400 transition-all cursor-pointer">
              {t.tryAudit}
            </button>
            <button className="bg-transparent border border-white/20 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-white/5 transition-all cursor-pointer">
              {t.learnMore}
            </button>
          </div>
