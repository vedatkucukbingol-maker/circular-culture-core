        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-16 border-t border-white/10 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-[10px] text-emerald-400 font-bold uppercase tracking-[0.2em]">{t.projects}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-white mb-2">45%</div>
              <div className="text-[10px] text-emerald-400 font-bold uppercase tracking-[0.2em]">{t.wasteRed}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-white mb-2">98%</div>
              <div className="text-[10px] text-emerald-400 font-bold uppercase tracking-[0.2em]">{t.retention}</div>
            </div>
          </div>
        </div>
      </main>
